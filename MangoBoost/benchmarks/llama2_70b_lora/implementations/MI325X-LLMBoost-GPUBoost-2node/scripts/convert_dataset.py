...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--data_dir", type=str, default="/data", help="The directory of the data files"
    )
    ...
    assert (
        directory_hash == "02e1f87d26ece4943a47bedcad0da5d4"
    ), f"Expected hash 02e1f87d26ece4943a47bedcad0da5d4 but got {directory_hash}"
