# MangoBoost MLPerf Training v5.1 Benchmark

This folder contains all of the code necessary to run:

+ MLPerf Training MI300X/MI325X Single-Node (8 GPUs on a single node)
+ MLPerf Training MI300X/MI325X Two-Node (16 GPUs across two node and Mango GPUBoost RDMA DPUs)

---

# 1. Prerequisites

- **Hardware:** AMD MI300X/MI325X or compatible GPUs, supported RDMA/NICs, and sufficient system resources.
- **Software:** 
...
export DGXSYSTEM="MI300X" # System name: [ MI300X | MI325X | ... ]
export DATADIR="/path/to/llama2/70b/data"
export MODELDIR="/path/to/llama2/70b/model"
export IMAGE_NAME="llmboost/mb-llmboost-training:mlperf-5.1-prod-multinode"
