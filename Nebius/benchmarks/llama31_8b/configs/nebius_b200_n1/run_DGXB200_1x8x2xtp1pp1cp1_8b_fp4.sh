...
export WORKDIR="/mnt/data/training_results_v5.1_Nebius-benchmarks.20251008/benchmarks/llama31_8b"
export CONT="/mnt/data/images/20251008/llama31_8b_20251008.sqsh"
export DATADIR="/mnt/data/datasets/llama31_8b"
export CFGDIR="./"
export LOGDIR="/mnt/data/runs/b200n1/llama31_8b/logs"

source "${CFGDIR}/config_DGXB200_1x8x2xtp1pp1cp1_8b_fp4.sh"
cd ${WORKDIR}
