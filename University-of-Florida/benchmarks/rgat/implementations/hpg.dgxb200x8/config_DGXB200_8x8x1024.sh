...
# tunable HPs
export EPOCHS="5"
export BATCHSIZE="1024" # local batch size "1024"
export VALIDATION_BATCHSIZE="2048"
export LEARNING_RATE="0.005" #was 0.003

export WARMUP_RATIO=0.10
export LR_SCHEDULE=cosine
# Keep regularization modest to avoid capping accuracy
export DROPOUT=0.08
export WEIGHT_DECAY=0.0035
...
export CUDA_GRAPH_ESTIMATION_BATCHES="32"
