...
_cont_mounts=("--volume=${DATADIR_PHASE2}:/workspace/data_phase2" "--volume=${CHECKPOINTDIR_PHASE1}:/workspace/phase1 " "--volume=${PWD}/run_and_time.sh:/workspace/bert/run_and_time.sh" "--volume=${PWD}/bindpcie:/workspace/bert/bindpcie" "--volume=${PWD}/run_and_time.sh:/workspace/bert/run_and_time.sh" "--volume=${PWD}/bind_cpu_topology.sh:/workspace/bert/bind_cpu_topology.sh" "--volume=${PWD}/bind_mem_topology.sh:/workspace/bert/bind_mem_topology.sh" )
