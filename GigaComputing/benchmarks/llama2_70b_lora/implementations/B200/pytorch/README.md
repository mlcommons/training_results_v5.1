...
# if using srun, instead do: srun --nodes=1 -t 24:00:00 --pty --container-image=<docker/registry>/mlperf-nvidia:llama2_70b_lora-pyt --container-mounts=</path/to/dataset>:/data -p <partition> -A <account> /bin/bash 
...
sbatch -N1 -t 4:00:00 download.sub
```
